...
class CancelContract extends StatefulWidget {
  final String contractID;
  CancelContract(this.contractID);

  @override
  State<StatefulWidget> createState() => CancelContractState();
}

class CancelContractState extends State<CancelContract> {
  double width, height;
  bool cancelListDropdown = true;
  String cancelHint = "- Select from below", error = "";
  TextEditingController cancelDetails = new TextEditingController();
  ...
  @override
  void initState() {
    if (listOfInfo.cancelList.isEmpty) {
      bloc.add(getCancelList());
    }
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AllPagesAppBar.appBar(context, true, false, "Cancel Contract"),
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                          ...
                          SvgPicture.asset("assets/contract.svg"),
                          SizedBox(
                            height: 30,
                          ),
                          Text(
                            "Please let us know why you want to cancel the contract ?",
  ...
  Widget dropDownView() {
    return Center(
      ...
      onTap: () {
        setState(() {
          cancelListDropdown = !cancelListDropdown;
        });
      },
      child: Center(
        child: AnimatedContainer(
          ...
          height: cancelListDropdown ? 52.0 : 250.0,
          duration: Duration(milliseconds: 0),
          curve: Curves.fastOutSlowIn,
          child: cancelListDropdown
              ?
                    ...
                    Expanded(
                      ...
                      child: Container(
                        ...
                        child: ListView.separated(
                            ...
                            itemCount: listOfInfo.cancelList.length,
                            separatorBuilder:
                            ...
                            itemBuilder: (BuildContext context, int index) {
                              return ListTile(
                                title: Text(listOfInfo.cancelList[index],
                                    style: TextStyle(
                                        color: Color.fromRGBO(101, 101, 101, 1),
                                        fontSize: 15)),
                                contentPadding:
                                ...
                                onTap: () {
                                  setState(() {
                                    cancelListDropdown = true;
                                    cancelHint = listOfInfo.cancelList[index];
                                  });
                                },
                              );
                            }),
    ...
    return Container(
      ...
      child: Material(
          ...
          child: FlatButton(
            ...
            onPressed: () async {
              if (cancelHint == "- Select from below") {
                setState(() {
                ...
                buttonBloc.add(cancelContract(widget.contractID, cancelHint,
                    cancelDetails.text.toString()));
              }
            },
          )),
    );
